...
public class HumidityStat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_humidity_stat);

        chart = findViewById(R.id.barchart3);
        ...
        databaseReference1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    float ph4=(float) sd.get(2).getHum();
                    float ph2=(float) sd.get(3).getHum();
                    float ph3=(float) sd.get(4).getHum();
